...
export default function getMyProfile() {
  ...
  apiGetProfile().then(response => {
    ...
    Object.assign(MyProfile, {
      ...
      champ1Winrate:
        String((100 * champData[0].CHAMP_WIN_RATE).toFixed(2)) + '%',
      champ2Winrate:
        String((100 * champData[1].CHAMP_WIN_RATE).toFixed(2)) + '%',
      champ3Winrate:
        String((100 * champData[2].CHAMP_WIN_RATE).toFixed(2)) + '%',
      ...
      line1Winrate: String((100 * lineData[0].LINE_WIN_RATE).toFixed(2)) + '%',
      line2Winrate: String((100 * lineData[1].LINE_WIN_RATE).toFixed(2)) + '%',
